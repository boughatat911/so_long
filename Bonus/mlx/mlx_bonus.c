...
/*   Updated: 2025/02/20 13:53:32 by nbougrin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_coin(t_game	*game)
{
	...
	game->textures.coin[1] = mlx_xpm_file_to_image(
			game->mlx, "textures/coin2.xpm", &w, &h);
	game->textures.coin[2] = mlx_xpm_file_to_image(
			game->mlx, "textures/coin3.xpm", &w, &h);
	game->textures.coin[3] = mlx_xpm_file_to_image(
			game->mlx, "textures/coin4.xpm", &w, &h);
